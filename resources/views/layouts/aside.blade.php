...
<nav class="sidebar sidebar-bunker">
    <div class="sidebar-header">
        <a href="{{route('home')}}" class="logo mx-auto"><span>Logo</span></a>
    </div><!--/.sidebar header-->
    <hr class="my-0 bg-success">
    <div class="profile-element d-flex align-items-center flex-shrink-0">
        <div class="avatar online">
            <img src="@if (Auth::user()->picture != ''){{asset(Auth::user()->picture)}} @else {{asset('images/avatar129.png')}} @endif" class="img-fluid rounded-circle" alt="">
        </div>
    ...
    <div class="sidebar-body">
        <nav class="sidebar-nav">
            <ul class="metismenu">
                ...
                <li class="@if($page == 'vehicle') mm-active @endif"><a href="{{route('vehicle.index')}}"><i class="fas fa-car mr-2"></i> Vehicles</a></li>
